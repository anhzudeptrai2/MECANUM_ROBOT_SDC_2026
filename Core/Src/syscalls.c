...
/*
 * Keil/ARMCC v5 uses Arm's C library (not Newlib), and does not ship
 * Newlib/Picolibc headers such as <sys/stat.h>, <sys/time.h>, <sys/times.h>.
 * The STM32CubeMX-generated syscalls.c is primarily for Newlib/Picolibc.
 *
 * This file therefore provides two implementations:
 * - ARMCC v5: minimal stdio retargeting (fputc/fgetc) + no semihosting.
 * - GCC/clang/Newlib/Picolibc: keep the original syscall stubs.
 */
...
#endif /* ARMCC v5 vs Newlib/Picolibc */
