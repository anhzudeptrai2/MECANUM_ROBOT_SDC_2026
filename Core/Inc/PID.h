 ...
 * For bidirectional motor control you typically want symmetric limits
 * (e.g. -255..255 or -1000..1000 depending on your PWM scaling).
 */
#ifndef _PID_OUTPUT_MIN_DEF
#define _PID_OUTPUT_MIN_DEF 0
#endif

#ifndef _PID_OUTPUT_MAX_DEF
#define _PID_OUTPUT_MAX_DEF _PID_8BIT_PWM_MAX
#endif
